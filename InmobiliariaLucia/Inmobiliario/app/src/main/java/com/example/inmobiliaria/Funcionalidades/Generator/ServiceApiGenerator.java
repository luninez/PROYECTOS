...
public class ServiceApiGenerator {
    ...
    private static final String MASRTER_KEY = "";
    ...
    public static  <S> S creatteService (Class<S> serviceClass, String userName, String userPassword){
                ...
                clientBuilder.addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        HttpUrl url = originalUrl.newBuilder()
                                .addQueryParameter("access_token", MASRTER_KEY)
                                .build();
